...
if (typeName _objects == "SIDE") then {
	switch (_objects) do {
			case west: 			{_units = f_param_men_BLU};
			case blufor: 		{_units = f_param_men_BLU};
			case east: 			{_units = f_param_men_OPF};
			case opfor: 		{_units = f_param_men_OPF};
			case resistance: 	{_units = f_param_men_RES};
			case independent: 	{_units = f_param_men_RES};
			case civilian: 		{_units = f_param_men_CIV};
	};
