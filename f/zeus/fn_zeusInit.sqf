...
if (isNil "f_param_sideCenter") then {
	f_param_sideCenter = createCenter sideLogic;
	publicVariable "f_param_sideCenter";
};

// Create a new curator logic
_curator = (createGroup f_param_sideCenter) createUnit ["ModuleCurator_F",[0,0,0] , [], 0, ""];
