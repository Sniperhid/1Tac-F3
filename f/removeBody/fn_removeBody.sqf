...
if (isNil "f_param_removeBodyDelay") then {f_param_removeBodyDelay = 20};
if (isNil "f_param_removeBodyDistance") then {f_param_removeBodyDistance = 50};

_wait = f_param_removeBodyDelay;
_distance = f_param_removeBodyDistance;
