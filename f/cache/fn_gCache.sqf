...
_aggressiveness = [_this,1,f_param_cachingAggressiveness] call BIS_fnc_param;

{
  ...
  switch (_aggressiveness) do {
    ...
    default {systemchat format ["f_fnc_gCache DBG: f_param_cachingAggressiveness is not an accepted value: %1",f_param_cachingAggressiveness];};
  };
