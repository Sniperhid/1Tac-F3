 ...
 * New variables f_param_cacheRun and f_param_cacheSleep to easier control component behavior during runtime.
...
* Variable f_param_debugMode is now always set (to 0 or 1) by the init.sqf file.
...
* Added new common variable: f_param_men_players (thanks to Raedor).
